...
<body>
    ...
    <div class="wrapper fixed__footer">
        ...
        <header id="header" class="htc-header header--3 bg__white" style="background-color: lightgreen;">
            ...
            <div id="sticky-header-with-topbar" class="mainmenu__area sticky__header" style="background-color: darkorange;">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-mxs-3 col-md-3 col-sm-2 col-xs-2">
                        <div style="display:flex">
                                <input type="text" id="searchFieldValue"  class="search" placeholder="Cari Kategori Olahragamu " aria-label="Recipient's username" aria-describedby="button-addon2">
                                <button id="searchButton" style="background-color: yellow;font-weight: 600;" class="btn btn-outline-secondary" type="button"  id="button-addon2"><a href="<?php echo site_url ('bukutamuuser') ?>">Search</button>
                                </div>
                        </div>
                        <!-- End MAinmenu Ares -->
                        <div class="col-md-3 col-sm-3 col-xs-3">  
                            <ul class="menu-extra">
                                <li id="adminButton" style="display:none"><a href="<?php echo site_url ('auth') ?>"><span style='font-size:15px' class="ti-user">Admin</span></a></li>
                                <li id="loginButton" style="display:none"><a href="<?php echo site_url ('auth') ?>"><span style='font-size:15px' class="ti-user">Login</span></a></li>
                                <li id="logoutButton" style="display:none"><a href="<?php echo site_url ('auth') ?>"><span style='font-size:15px' class="ti-user">Logout</span></a></li>                            
                            </ul>
                        </div>
                    </div>
            ...
            <!-- End Mainmenu Area -->
            <script type="text/javascript" src="<?php echo base_url('assets1/js/headerUser.js');?>"></script>
