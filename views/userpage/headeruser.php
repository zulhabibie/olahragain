                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-3">  
                            <ul class="menu-extra">
                                <li id="adminButton" style="display:none"><a href="<?php echo site_url ('databuku') ?>"><span class="ti-user">Admin</span></a></li>
                                <li id="loginButton" style="display:none"><a  href="<?php echo site_url ('auth') ?>"><span class="ti-user">Login</span></a></li>
                                <li id="logoutButton" style="display:none"><a  href="<?php echo site_url ('auth') ?>"><span class="ti-power-off">Logout</span></a></li>
